...
function handleQrLoadError(imgElement) {
  if (!imgElement) return;
  const backupUrl =
    "https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=upi://pay?pa=7447468986@naviaxis&pn=Sairaj%20Prashant%20Deshmukh&am=101";
  ...
  const msg = document.getElementById("qrFallbackMsg");
